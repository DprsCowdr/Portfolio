...
const journeySteps = [
  ...
  },
  {
    ...
    date: 'Now',
    description: 'Ready to contribute in entry-level IT support, QA, web development, or technical operations roles.',
    ...
    <div className="career-container">
      ...
      <div className="career-map-shell">
        <svg className="career-road" viewBox="0 0 1200 960" preserveAspectRatio="none" aria-hidden="true">
          <path className="career-road-base" d="M-70 720 H115 C260 720 220 520 370 520 H485 C620 520 560 740 735 740 H820 C930 740 890 290 1040 290 H1270" />
          <path className="career-road-dash" d="M-70 720 H115 C260 720 220 520 370 520 H485 C620 520 560 740 735 740 H820 C930 740 890 290 1040 290 H1270" />
        </svg>
